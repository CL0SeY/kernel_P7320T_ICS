...
struct platform_device msm_device_sdio_al_lpm = {
	.name = "msm_sdio_al",
	.id = -1,
	.dev		= {
		.platform_data	= &sdio_al_pdata,
...
#ifdef CONFIG_MSM_SDIO_AL
static struct platform_device *charm_devices_lpm[] __initdata = {
	&msm_device_sdio_al_lpm,
};
#endif
...
static void __init msm8x60_init(struct msm_board_data *board_data)
{
	...
	if(charging_mode_from_boot == 1) {
#ifdef CONFIG_MSM_SDIO_AL
		platform_add_devices(charm_devices_lpm, ARRAY_SIZE(charm_devices_lpm));
#endif
	}
	else
