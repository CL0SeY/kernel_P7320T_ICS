...
static void treat_error_status(void)
{
	...
	if (ta_status) {
		...
		/* 8:MFFREQ[0] */
		error |= change_config(data, obj_address, 8, 10);//20120924
		/* 9:MFFREQ[1]*/
		error |= change_config(data, obj_address, 9, 15);//20120924
		/* 17:GCMAXADCSPERX */
		error |= change_config(data, obj_address, 17, 100);
		/* 22:MFINVLDDIFFTHR */
		error |= change_config(data, obj_address, 22, 100);//20120924
		/* 34:BLEN[0] */
		error |= change_config(data, obj_address, 34, 96);//20120924
		/* 35:TCHTHR[0] */
		error |= change_config(data, obj_address, 35, 40);//20120924
		/* 39:MOVFILTER[0] */
